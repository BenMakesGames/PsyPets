<?php
$TIP_TEXT = array(
  'The "Psy" in "PsyPets" is for "psychology"!  And speaking of psychology, did you know that people think better just after they\'ve eaten?  It\'s true!  So go grab a snack, or have a little fruit juice before diving into PsyPets!  Yeah, right now!  I can wait; it\'s not a problem!',
  ...
  'PsyPets can reset your password if you forget it, but only if your e-mail address is up to date!  Keep it up to date using the <a href="/myaccount/">My Account</a> &gt; <a href="/myaccount/security.php">Account Management</a> page.',
  ...
  'Most alcoholic items in PsyPets give a pet esteem, however they also make the pet tired.',
  ...
  'By signing up for PsyPets, you also have an account at <a href="http://wiki.psypets.net">PsyHelp - the PsyPets wiki</a>.  You can log into it using your PsyPets Resident name and password.',
  ...
  'PsyPets has several color schemes you can choose from.  To change your color scheme, visit the <a href="/myaccount/">My Account</a> &gt; <a href="/myaccount/display.php">Display Settings</a> page.',
  'A lot of ideas for PsyPets come from books.  You can find a list of these books on the <a href="/help/">Help Index</a> &gt; <a href="/recreading.php">"Recommended" Reading</a> page.',
