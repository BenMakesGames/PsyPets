...
<?php
  echo '<h4>Feature Drive: ' . $voting_on . '</h4>';
...
<?php
  ...
  echo '<p class="failure">Anyone who <a href="buyfavors.php">buys Favor</a> during Feburary can vote.  Voting ends March.  (Votes made with alternate accounts will be removed when spotted.)</p>';

echo '<h5>Current Standings</h5>';
...
<?php
  ...
  echo '<p>No one has made any suggestions yet!</p>';
/*
if($user['admin']['alphalevel'] >= 6)
  echo '
    <h5>Admin Tools</h5>
    <ul>
     <li><a href="adminclearfeaturedrive.php">Clear feature drive suggestions</a></li>
    </ul>
  ';
*/
?>
