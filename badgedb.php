...
?>
<?php
echo '<a href="/npcprofile.php?npc=The Librarian"><img src="//' . $SETTINGS['static_domain'] . '/gfx/npcs/the-librarian.png" align="right" width="350" height="" alt="(The Librarian)" /></a>';
