...
<?php include 'commons/header_2.php'; ?>
     ...
     <ul class="tabbed">
      <li class="activetab"><a href="locationeditor_gathering.php">Gathering</a></li>
...
<?php
$result = mysql_query('SELECT * FROM psypets_locations WHERE type=\'gather\' ORDER BY level ASC');
...
?></td>
 ...
 <td valign="top" align="right">(<?= 70 + $location['level'] ?>%)</td>
