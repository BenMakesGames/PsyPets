...
<?php include 'commons/header_2.php'; ?>
     ...
     <ul class="tabbed">
      ...
      <li class="activetab"><a href="locationeditor_mines.php">Mining</a></li>
      <li><a href="locationeditor_lumberjacking.php">Lumberjacking</a></li>
     </ul>
     <ul>
...
<?php
$result = mysql_query('SELECT * FROM psypets_locations WHERE type=\'mine\' ORDER BY level ASC');
...
?></td>
 ...
 <td valign="top"><?php
  ...
  $expected_moneys_value = 20 + $location['level'] * 4 + floor($location['level'] * $location['level'] / 10);
 ?></td>
 <td valign="top" align="right"><?= 100 - round($drop_rate * 100) ?>%</td>
 <td valign="top" align="right">(<?= 65 + $location['level'] ?>-<?= 75 + $location['level'] ?>%)</td>
