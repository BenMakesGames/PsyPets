...
if($admin["massmail"] == "yes")
  echo "<p>If you want to message everyone, use the <a href=\"/admin/tools.php\">admin tools</a></p>\n";
?>
...
<?php
if($user['license'] == 'yes' && $num_inventory_items > 0)
{
  if($SEND_PACKAGE === true)
  {
?>
<table>
 <tr>
 ...
 <tr>
  <td colspan=2>
<?php
 display_inventory($whereat, $my_inventory, $user, $pet);
?>
  </td>
 </tr>
 <tr>
...
<?php
    ...
    echo '<p><input type="submit" name="submit" value="Show Items" class="bigbutton" /></p>';
}
?>
</form>
