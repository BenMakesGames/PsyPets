...
/* updates god moods, and maybe starts an auction
   ...
   /usr/local/php5/bin/php /home/a001337/psypets.net/

   cron job list
     0 12 * * * df -h | mail -s "Partition report" -a From:sender@psypets.net admin@psypets.net
     0 12 * * * /usr/local/php5/bin/php /home/a001337/backup_check.php | mail -s "Backup report" -a From:sender@psypets.net admin@psypets.net
     1 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/dailyitemvalue.php l33t4cc355 | mail -s "Maintenance report: dailyitemvalue.php" -a From:sender@psypets.net admin@psypets.net
     2 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/dailymarketgamesell.php l33t4cc355 | mail -s "Maintenance report: dailymarketgamesell.php" -a From:sender@psypets.net admin@psypets.net
     3 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/daily_market_record.php l33t4cc355 | mail -s "Maintenance report: daily_market_record.php" -a From:sender@psypets.net admin@psypets.net
     7 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/considergods.php l33t4cc355 | mail -s "Maintenance report: considergods.php" -a From:sender@psypets.net admin@psypets.net
     8 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/dailygroupcheck.php l33t4cc355 | mail -s "Maintenance report: dailygroupcheck.php" -a From:sender@psypets.net admin@psypets.net
     9 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/takestats.php l33t4cc355 | mail -s "Maintenance report: takestats.php" -a From:sender@psypets.net admin@psypets.net
     11 0 * * * /usr/local/php5/bin/php /home/a001337/psypets.net/dailyoptimize.php l33t4cc355 | mail -s "Maintenance report: dailyoptimize.php" -a From:sender@psypets.net admin@psypets.net
*/

$IGNORE_MAINTENANCE = true;

ini_set('include_path', '/home/a001337/psypets.net');
...
if(array_key_exists("l33t4cc355", $_GET) || in_array('l33t4cc355', $argv))
{
