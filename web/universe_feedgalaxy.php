...
$hydrogen = (int)$_POST['hydrogen'];

if($hydrogen > 0)
{
  if($hydrogen > $universe['hydrogen'])
    $hydrogen = $universe['hydrogen'];

  spend_hydrogen($universe, $hydrogen);
  feed_galaxy_hydrogen($galaxy, $hydrogen);
}
