...
<?php include 'commons/header_2.php'; ?>
     ...
     <table>
      ...
      <tbody>
       ...
       <tr class="altrow"><th>Favor</th><td>These items are available for <a href="/buyfavors.php">Favor</a>.  Many Favor items are available only during certain times of the year, from certain NPCs (notably, <a href="/af_getrare2.php">The Smithery's Unique Item Shop</a>).</td></tr>
       <tr class="row"><th>Erstwhile</th><td>These items used to be available for <a href="/buyfavors.php">Favor</a>, but were discontinued.  However, they are now available at random via the <?= item_text_link('Erstwhile Wand'); ?>.</td></tr>
