...
<body>
    ...
    <a href="/npcprofile.php?npc=Maya Wirt"><img src="gfx/npcs/advertising.png" align="right" width="350" height="380" alt="(Maya Wirt, advertising receptionist)" /></a>
    ...
    <?php if($TIME_IS_FUCKED === true): ?>
        <p>Unfortunately, Advertising has been disabled for the moment.  An explanation should have been posted in the <a href="/cityhall.php">City Hall</a>...</p>
        <?php include 'commons/dialog_close.php'; ?>
    <?php else: ?>
        <?php if($this_ad === false): ?>
            ...
            <form method="post">
                <?php if($airtime_error): ?>
                    <p class="failure"><?= $airtime_error ?></p>
                <?php endif; ?>
                <table>
                    <tr class="titlerow">
                        <th>&nbsp;</th>
                ...
                <?php if($message_error): ?>
                    <p class="failure"><?= $message_error ?></p>
                <?php endif; ?>
                <h5>Message</h5>
                <table>
                    <tr>
        ...
        <?php else: ?>
            ...
            <?php $days_left = ceil(($this_ad["expirytime"] + 1 - $now) / (60 * 60 * 24)); ?>
