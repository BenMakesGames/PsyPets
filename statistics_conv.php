...
$chart_info = array(
  'type' => 'line',
  'colors' => array('#48b'),
  'legend' => array('Percent of Paying Players'),
);
...
{
  $paying = $database->FetchSingle('
    SELECT COUNT(DISTINCT(idnum)) AS value
  ...
  $value = round($paying['value'] * 100 / $row['nummonthlyusers'], 2);
...
?>
 <head>
  <title><?= $SETTINGS['site_name'] ?> &gt; Statistics &gt; Monthly Percent of Paying Players</title>
<?php include "commons/head.php"; ?>
  <script type="text/javascript" src="//<?= $SETTINGS['static_domain'] ?>/js/protovis.min.js"></script>
 </head>
 <body>
<?php include 'commons/header_2.php'; ?>
    <h4><a href="/statistics.php">Statistics</a> &gt; Monthly Percent of Paying Players</h4>
    <ul class="tabbed">
      <li class="activetab"><a href="statistics_conv.php">Percent of Paying Players</a></li>
      <li><a href="statistics_arpu.php">ARPU</a></li>
