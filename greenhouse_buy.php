...
// value of items produced / cost to get plant should equal ~20
// ex: 8 steak x 75m/steak = 600; 600 / 30 (cost ot steakvine) = 20
$items_out = array(
  2 => array('Amethyst Rose Bush', 55), // 18 Amethyst Roses + 1 Wood (55 x 18 + 95 = 1085)
  1 => array('Appleberry Bush', 20),    // 18 Redsberry/Delicious + 1 Wood ((15 + 20) / 2 x 18 + 95 = 410)
  3 => array('Bonsai Tree', 40),        // nothing
 11 => array('Camomile Seeds', 3),      //
  4 => array('Minipalm', 25),           // 8 Coconuts + 1 Log (35 x 8 + 95 x 2.5 = 517.5)
  9 => array('Potted Cornstalk', 30),   // 8 Corn (75 x 8 = 600)
// 11 => array('Potted Oakle Tree', 500), // STUFF
  5 => array('Potted Orange Tree', 35), // 12 Oranges + 1 Log (40 x 12 + 95 x 2.5 = 717.5)
  6 => array('Potted Rubber Tree', 60), // 10 Rubber + 1 Log (95 x 10 + 95 x 2.5 = 1187.5)
  8 => array('Potted Steakvine', 30),   // 8 Steak (75 x 8 = 600)
  7 => array('Potted Sugar Beets', 15), // 9 Sugar Beets (30 x 9 = 270)
 10 => array('Potted Wheat', 20),       // 7 Wheat (60 x 7 = 560)
);
...
<?php include 'commons/header_2.php'; ?>
  ...
  <h4>The Florist &gt; Greenhouse &gt; Buy Plants</h4>
  <ul class="tabbed">
   <li><a href="florist.php">Buy</a></li>
   <li><a href="florist_anonymous.php">Send Anonymously</a></li>
...
{
  echo '
    <p>Oh, I grow lots of things besides just flowers, of course!</p>
    <p>If you\'d like to buy some of my other plants, you can pay me in pet crafts.  I have so many Hungry Cherubs that need feeding...</p>
    <p>I\'ve also worked out a deal with Ian at <a href="/recycling.php">Recycling</a>... for every 20 items recycled, you\'ll receive 1 Greenhouse Point.</p>
  ';
}
...
?>
  <ul class="tabbed">
   <li><a href="greenhouse.php">Sell Items</a></li>
   <li class="activetab"><a href="greenhouse_buy.php">Buy Plants</a></li>
  </ul>
  <p>You have <?= $user['greenhouse_points'] ?> Greenhouse Points.</p>
  <form action="greenhouse_buy.php" method="post">
  <table>
...
foreach($items_out as $id=>$item_cost)
{
  ...
  echo '
    <tr class="' . $rowclass . '">
     <td><input type="number" name="i_' . $id . '" size="2" maxlength="2" class="quantity" /></td>
